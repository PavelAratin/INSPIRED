  ...
  <div class="container">
      <div class="header__top">
        ...
        <a class="logo" href="card-detail.html">
          <img src="../../img/logo.png" alt="Логотип сайта нижнего белья INSPIRED">
        </a>
          ...
          <li class="list-actions__item">
            <a class="list-actions__link" href="#">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M16.4431 16.4438L20.9994 21.0002" stroke="black" stroke-width="2" stroke-linecap="round"
                  stroke-linejoin="round" />
              </svg>
            </a>
          </li>
          <li class="list-actions__item">
            <a class="list-actions__link" href="cart.html">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
